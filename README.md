...
|   | :heavy_check_mark: ([try](https://try.ps.ai/?github=JordanMartinez/purescript-cookbook/master/recipes/SuperCircles/src/Main.purs)) | [SuperCircles](recipes/SuperCircles) | A simplified Super Hexagon clone written in PureScript. There are only two controls: the left and right arrow keys. |
