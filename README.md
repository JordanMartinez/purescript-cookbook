...
| :heavy_check_mark: | :heavy_check_mark: | [HeterogenousArrayLog](recipes/HeterogenousArrayLog) | This recipe shows how to create, display, and pattern match on a heterogenous array. |
